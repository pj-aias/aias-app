...
interface SMSInputScreenState {
  codeText: string;
}

export class SMSInputScreen extends Component<{}, SMSInputScreenState> {
  ...
  private handleSubmit = () => {
    Alert.alert('this is you phone number: ' + this.state.codeText);
  }
